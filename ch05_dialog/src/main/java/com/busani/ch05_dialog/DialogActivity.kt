package com.busani.ch05_dialog
...
import com.busani.ch05_dialog.databinding.ActivityDialogBinding
import com.busani.ch05_dialog.databinding.CustomDialogBinding
...
class DialogActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 2. 날짜 선택 다이얼로그 [DatePickerDialog]
        binding.button2.setOnClickListener {

            // 사용자에게 기본값으로 보여줄 년/월/일
        ...
        binding.button7.setOnClickListener {
            // 뷰 바인딩을 사용해서 custom_dialong.xml 레이아웃을 인플레이트
