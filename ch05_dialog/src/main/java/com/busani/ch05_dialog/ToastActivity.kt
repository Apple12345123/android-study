...
import com.busani.ch05_dialog.databinding.ActivityToastBinding
import com.busani.ch05_dialog.databinding.CustomSnackbarBinding
import com.google.android.material.snackbar.Snackbar

class ToastActivity : AppCompatActivity() {
    @SuppressLint("RestrictedApi")      // 경고를 무시하는 애너테이션
    @RequiresApi(30)        // 하위호환성 애너테이션의 경유 오류를 무시하기만 함.
