package com.busani.ch09_recycler_view.recyclerView
...
import com.busani.ch09_recycler_view.databinding.ActivityInsertBinding
import com.busani.ch09_recycler_view.databinding.StudentItemBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.run {
            ...
            addButton.setOnClickListener {
                ...
                // 특정위치에 아이템이 제거됨
//                val position = 1 // 위치를 알 경우 (2번째 항목이 지워짐을 알림)
