package com.busani.ch09_recycler_view.listView
...
import com.busani.ch09_recycler_view.R
import com.busani.ch09_recycler_view.databinding.ActivityListViewBinding
import com.busani.ch09_recycler_view.databinding.CarItemBinding
...
class ListViewActivity : AppCompatActivity() {
    ...
    class ListViewAdapter(
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            // 객체 바인딩 선언
            // 1. LayoutInflater 객체 : XML -> View 객체로 변환
            // 2. ViewGroup 객체 : 인플레이트 된 뷰의 부모 뷰 그룹을 지정 parent
            // 3. attatchToParent : 인플레이트된 뷰를 즉시 부모 뷰그룹에 추가할지 여부 (일반적으로 false)
