package com.busani.ch11_persistence.a_preference
...
class PreferenceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 첫번째 매개변수 : 파일 이름, 두번째 매개변수 : 파일이 이 앱에서만 사용됨
        ...
        binding.run {
            ...
            buttonClear.setOnClickListener {
                sharedPreferences.edit().remove("user_name")    // 키에 해당하는 데이터 삭제
                                     // .clear() //  전체 데이터 삭제
                                        .apply()  // 변경사항 적용
            }
        }
