package com.busani.ch11_persistence.ex_todo

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.busani.ch11_persistence.databinding.ItemTodoBinding
...
class TodoAdapter(
    ...
    private val deleteClickListener: (Todo) -> Unit     // 매개변수로 함수 전달
    ...
    inner class TodoViewHolder(val binding: ItemTodoBinding) :
        ...
        fun bind(todo: Todo) {
            ...
            binding.deleteButton.setOnClickListener {
                // deleteClickListener(todo)       // 전달 받은 이벤트 핸들러
                deleteTodo(todo)
            }
        }
        ...
        fun deleteTodo(todo: Todo) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                todoList = dao.getAllTodos()       // DB에서 모든 항목을 조회
