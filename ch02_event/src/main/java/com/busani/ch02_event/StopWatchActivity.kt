...
import com.busani.ch02_event.databinding.ActivityStopWatchBinding

class StopWatchActivity : AppCompatActivity() {

    var initTime = 0L        // 초기시간
    var pauseTime = 0L       // 멈춘시각
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Chronometer : 시간을 사용하는 데 사용하는 UI 위젯. 시간의 경과를 초 단위로 보여줌
