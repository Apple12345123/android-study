...
import com.busani.ch06_notification.databinding.ActivityPendingBinding
...
class PendingActivity : AppCompatActivity() {
    ...
    fun notification() {
        ...
        // 메시지를 터치하면 다른 Activity를 실행하는 Intent 객체를 만든다.
        ...
        /*
        PendingIntent : 알림을 클릭했을 때 애플리케이션의 특정 Activity 실행시키는 메시지
